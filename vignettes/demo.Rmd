...
K3, the popular Flemish/Dutch band. It provides
...
Showing the first 2 songs with its composers:

```{r}
knitr::kable(head(get_composers()))
```
...
composer_tally <- dplyr::count(composers, composer)
ggplot2::ggplot(
  data = composer_tally, 
  ggplot2::aes(x = composer, y = n)
) + ggplot2::geom_col() + 
  ggplot2::theme(
